...
//   const { firstname, lastname, email,  password, mobileNo, confirmPassword } = values;
...
//   try{
//     let user = await firebase.auth().sendPasswordResetEmail(email);

//     dispatch({type: PASSWORD_RESET_SUCCESS, payload: user})
  
//   }catch (err){
//     console.log(err);
//     dispatch({type: PASSWORD_RESET_FAIL, payload: err})
//   }
// }
...
//   try{
//     let user = await firebase.auth().confirmPasswordReset("code", "newPassword")
//     dispatch({type: PASSWORD_CHANGE_SUCCESS, payload: user})
//   }catch(err){
//     console.log(err);
//     dispatch({type: PASSWORD_CHANGE_FAIL, payload: err})
//   }
// }